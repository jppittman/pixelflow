...
mod tests {
    ...
    #[test]
    fn simple_chars_should_succeed_when_invoked() {
    ...
    #[test]
    fn ctrl_chars_should_succeed_when_invoked() {
        let modes = DecPrivateModes::default();
        // Test Ctrl+c
        assert_eq!(
    ...
    #[test]
    fn alt_chars_should_succeed_when_invoked() {
        let modes = DecPrivateModes::default();
        assert_eq!(
    ...
    #[test]
    fn arrow_keys_normal_mode_should_succeed_when_invoked() {
    ...
    #[test]
    fn arrow_keys_app_mode_should_succeed_when_invoked() {
        let mut modes = DecPrivateModes::default();
    ...
    #[test]
    fn shift_tab_should_succeed_when_invoked() {
        let modes = DecPrivateModes::default();
        assert_eq!(
