...
mod tests {
    ...
    #[test]
    fn paste_text_action_bracketed_on_works() {
    ...
    #[test]
    fn paste_text_action_bracketed_off_works() {
        let mut emu = create_test_emu_for_input();
    ...
    #[test]
    fn control_event_resize_returns_resize_pty_action_works() {
        let mut emu = create_test_emu_for_input();
    ...
    #[test]
    fn control_event_resize_minimum_dimensions_works() {
        let mut emu = create_test_emu_for_input();
    ...
    #[test]
    fn control_event_request_snapshot_returns_none_works() {
        let mut emu = create_test_emu_for_input();
    ...
    #[test]
    fn control_event_pty_data_ready_returns_none_works() {
        let mut emu = create_test_emu_for_input();
