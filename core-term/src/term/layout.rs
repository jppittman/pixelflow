...
mod tests {
    ...
    #[test]
    fn pixels_to_cells_basic_should_compute_cells_when_called() {
        let layout = Layout {
            cols: 80,
            rows: 24,
            cell_width_px: 10,
    ...
    #[test]
    fn pixels_to_cells_with_padding_should_compute_cells_when_called() {
        let layout = Layout {
            cols: 80,
            rows: 24,
            cell_width_px: 10,
    ...
    #[test]
    fn pixels_to_cells_out_of_bounds_should_clamp_when_called() {
        let layout = Layout {
            cols: 80,
            rows: 24,
            cell_width_px: 10,
    ...
    #[test]
    fn cells_to_pixels_should_compute_pixels_when_called() {
        let layout = Layout {
            cols: 80,
            rows: 24,
            cell_width_px: 10,
    ...
    #[test]
    fn pixel_dimensions_should_compute_size_when_called() {
        let layout = Layout {
            cols: 80,
            rows: 24,
            cell_width_px: 10,
    ...
    #[test]
    fn resize_should_update_layout_when_called() {
