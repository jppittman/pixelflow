...
mod tests {
    ...
    #[test]
    fn verify_selection_default_state() {
    ...
    #[test]
    fn verify_update_selection_marks_old_and_new_lines_dirty() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_update_selection_when_not_active() {
        let mut screen = create_test_screen(10, 5);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Cell); // Replaced Normal with Cell
    ...
    #[test]
    fn verify_is_selected_normal_no_selection() {
        let screen = create_test_screen(10, 5);
        assert!(!screen.is_selected(Point { x: 1, y: 1 }));
    }

    #[test]
    fn verify_is_selected_normal_single_line() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_normal_multi_line() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_normal_multi_line_selection_ends_at_width_minus_1() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_normal_reverse_selection_points() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_point_equals_start_or_end() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_out_of_bounds_point() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_block_no_selection() {
        let screen = create_test_screen(10, 5);
        assert!(!screen.is_selected(Point { x: 1, y: 1 }));
    }

    #[test]
    fn verify_is_selected_block_simple() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_is_selected_block_reverse_points() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_get_selected_text_normal_no_selection() {
        let screen = create_test_screen(10, 5);
        assert_eq!(screen.get_selected_text(), None);
    }

    #[test]
    fn verify_get_selected_text_normal_single_char() {
    ...
    #[test]
    fn verify_get_selected_text_normal_single_line_partial() {
        let mut screen = create_test_screen(5, 3);
        fill_screen_with_pattern(&mut screen);
    ...
    #[test]
    fn verify_get_selected_text_normal_single_line_full() {
        let mut screen = create_test_screen(5, 3);
        fill_screen_with_pattern(&mut screen);
        screen.start_selection(Point { x: 0, y: 0 }, SelectionMode::Cell); // Replaced Normal with Cell
        screen.update_selection(Point {
    ...
    #[test]
    fn verify_get_selected_text_normal_multi_line() {
    ...
    #[test]
    fn verify_get_selected_text_normal_multi_line_reversed_points() {
        let mut screen = create_test_screen(3, 3);
        fill_screen_with_pattern(&mut screen);
    ...
    #[test]
    fn verify_get_selected_text_normal_trailing_spaces_behavior() {
    ...
    #[test]
    fn verify_get_selected_text_block_no_selection() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn verify_get_selected_text_block_simple() {
    ...
    #[test]
    fn verify_get_selected_text_block_reversed_points() {
        let mut screen = create_test_screen(5, 4);
        fill_screen_with_pattern(&mut screen);
    ...
    #[test]
    fn verify_get_selected_text_block_one_column() {
        let mut screen = create_test_screen(5, 4);
        fill_screen_with_pattern(&mut screen);
        screen.start_selection(Point { x: 1, y: 0 }, SelectionMode::Block);
        screen.update_selection(Point { x: 1, y: 2 });
    ...
    #[test]
    fn verify_get_selected_text_block_one_row() {
        let mut screen = create_test_screen(5, 4);
        fill_screen_with_pattern(&mut screen);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Block);
        screen.update_selection(Point { x: 3, y: 1 });
    ...
    #[test]
    fn verify_get_selected_text_block_beyond_line_length() {
    ...
    #[test]
    fn verify_selection_cleared_on_resize() {
        let mut screen = create_test_screen(10, 5);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Cell); // Replaced Normal with Cell
        screen.update_selection(Point { x: 5, y: 2 });
    ...
    #[test]
    fn verify_scroll_up_populates_scrollback() {
    ...
    #[test]
    fn verify_block_selection_wide_char_full() {
    ...
    #[test]
    fn verify_block_selection_wide_char_partial_left() {
        let mut screen = create_screen_with_wide_char();
    ...
    #[test]
    fn verify_block_selection_wide_char_partial_right() {
        let mut screen = create_screen_with_wide_char();
