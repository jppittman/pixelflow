...
mod tests {
    ...
    #[test]
    fn selection_default_state_should_succeed_when_invoked() {
    ...
    #[test]
    fn update_selection_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
        let start_point = Point { x: 1, y: 1 };
    ...
    #[test]
    fn update_selection_marks_old_and_new_lines_dirty_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn update_selection_when_not_active_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Cell); // Replaced Normal with Cell
    ...
    #[test]
    fn end_selection_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Cell); // Replaced Normal with Cell
    ...
    #[test]
    fn is_selected_normal_no_selection_should_succeed_when_invoked() {
        let screen = create_test_screen(10, 5);
        assert!(!screen.is_selected(Point { x: 1, y: 1 }));
    }

    #[test]
    fn is_selected_normal_single_line_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_normal_multi_line_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_normal_multi_line_selection_ends_at_width_minus_1_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_normal_reverse_selection_points_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_point_equals_start_or_end_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_out_of_bounds_point_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_block_no_selection_should_succeed_when_invoked() {
        let screen = create_test_screen(10, 5);
        assert!(!screen.is_selected(Point { x: 1, y: 1 }));
    }

    #[test]
    fn is_selected_block_simple_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn is_selected_block_reverse_points_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn get_selected_text_normal_no_selection_should_succeed_when_invoked() {
        let screen = create_test_screen(10, 5);
        assert_eq!(screen.get_selected_text(), None);
    }

    #[test]
    fn get_selected_text_normal_single_char_should_succeed_when_invoked() {
    ...
    #[test]
    fn get_selected_text_normal_single_line_partial_should_succeed_when_invoked() {
        let mut screen = create_test_screen(5, 3);
        fill_screen_with_pattern(&mut screen);
    ...
    #[test]
    fn get_selected_text_normal_single_line_full_should_succeed_when_invoked() {
        let mut screen = create_test_screen(5, 3);
        fill_screen_with_pattern(&mut screen);
        screen.start_selection(Point { x: 0, y: 0 }, SelectionMode::Cell); // Replaced Normal with Cell
        screen.update_selection(Point {
    ...
    #[test]
    fn get_selected_text_normal_multi_line_should_succeed_when_invoked() {
    ...
    #[test]
    fn get_selected_text_normal_multi_line_reversed_points_should_succeed_when_invoked() {
        let mut screen = create_test_screen(3, 3);
        fill_screen_with_pattern(&mut screen);
    ...
    #[test]
    fn get_selected_text_normal_trailing_spaces_behavior_should_succeed_when_invoked() {
    ...
    #[test]
    fn get_selected_text_block_no_selection_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
    ...
    #[test]
    fn get_selected_text_block_simple_should_succeed_when_invoked() {
    ...
    #[test]
    fn get_selected_text_block_reversed_points_should_succeed_when_invoked() {
        let mut screen = create_test_screen(5, 4);
        fill_screen_with_pattern(&mut screen);
    ...
    #[test]
    fn get_selected_text_block_one_column_should_succeed_when_invoked() {
        let mut screen = create_test_screen(5, 4);
        fill_screen_with_pattern(&mut screen);
        screen.start_selection(Point { x: 1, y: 0 }, SelectionMode::Block);
        screen.update_selection(Point { x: 1, y: 2 });
    ...
    #[test]
    fn get_selected_text_block_one_row_should_succeed_when_invoked() {
        let mut screen = create_test_screen(5, 4);
        fill_screen_with_pattern(&mut screen);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Block);
        screen.update_selection(Point { x: 3, y: 1 });
    ...
    #[test]
    fn get_selected_text_block_beyond_line_length_should_succeed_when_invoked() {
    ...
    #[test]
    fn selection_cleared_on_resize_should_succeed_when_invoked() {
        let mut screen = create_test_screen(10, 5);
        screen.start_selection(Point { x: 1, y: 1 }, SelectionMode::Cell); // Replaced Normal with Cell
        screen.update_selection(Point { x: 5, y: 2 });
    ...
    #[test]
    fn scroll_up_populates_scrollback_should_succeed_when_invoked() {
    ...
    #[test]
    fn block_selection_wide_char_full_should_succeed_when_invoked() {
    ...
    #[test]
    fn block_selection_wide_char_partial_left_should_succeed_when_invoked() {
        let mut screen = create_screen_with_wide_char();
    ...
    #[test]
    fn block_selection_wide_char_partial_right_should_succeed_when_invoked() {
        let mut screen = create_screen_with_wide_char();
