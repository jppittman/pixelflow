...
#[test]
fn carriage_return_input_works() {
    let mut term = create_test_emulator(10, 1);
    term.interpret_input(EmulatorInput::Ansi(AnsiCommand::Print('A')));
    term.interpret_input(EmulatorInput::Ansi(AnsiCommand::Print('B')));
...
#[test]
fn csi_cursor_forward_cuf_works() {
...
#[test]
fn csi_ed_clear_below_csi_j_works() {
...
#[test]
fn mouse_press_starts_selection_works() {
...
#[test]
fn mouse_drag_updates_selection_works() {
    let mut emu = create_test_emulator(10, 5);
...
#[test]
fn mouse_release_ends_selection_activity_works() {
    let mut emu = create_test_emulator(10, 5);
    send_mouse_input(&mut emu, start_selection_at(1, 1), MouseButton::Left);
...
// --- Copy Action Tests ---
#[test]
fn initiate_copy_no_selection_works() {
    let mut emu = create_test_emulator(10, 5);
...
#[test]
fn initiate_copy_with_selection_works() {
...
#[test]
fn initiate_copy_block_selection_works() {
...
#[test]
fn new_mouse_press_clears_old_selection_works() {
    let mut emu = create_test_emulator(10, 5);
...
#[test]
fn selection_coordinates_adjust_on_scroll_works() {
...
#[test]
fn selection_on_alt_screen_then_exit_works() {
    let mut emu = create_test_emulator(10, 3);
    fill_emulator_screen(
        &mut emu,
...
#[test]
fn resize_smaller_content_truncation_works() {
    let mut term = create_test_emulator(5, 2);
...
#[test]
fn key_event_printable_char_works() {
    let mut term = create_test_emulator(5, 1);
...
#[test]
fn snapshot_with_selection_works() {
    let num_cols = 10;
    let num_rows = 2;
...
#[test]
fn mode_show_cursor_dectcem_works() {
    let mut term = create_test_emulator(5, 1);
...
#[test]
fn ps1_multiline_prompt_at_bottom_causes_scroll_works() {
...
#[test]
fn ps1_multiline_prompt_ends_on_last_line_no_scroll_by_prompt_works() {
    let mut term = create_test_emulator(5, 3);
...
#[test]
fn ps1_multiline_prompt_last_line_fills_screen_then_input_works() {
    let mut term = create_test_emulator(3, 2);
...
#[test]
fn ps1_prompt_causes_multiple_scrolls_works() {
    let mut term = create_test_emulator(3, 2);
...
#[test]
fn ps1_prompt_with_internal_wrapping_and_scrolling_works() {
    let mut term = create_test_emulator(3, 2);
    for _ in 0..3 {
        term.interpret_input(EmulatorInput::Ansi(AnsiCommand::Print('A')));
    }
...
#[test]
fn ps1_multiline_exact_fill_then_scroll_on_final_lf_works() {
    let mut term = create_test_emulator(3, 2);
...
#[test]
fn ps1_multiline_with_sgr_at_bottom_scrolls_works() {
    let mut term = create_test_emulator(5, 2);
...
#[test]
fn lf_at_bottom_of_partial_scrolling_region_no_origin_mode_works() {
    let cols = 10;
    let rows = 5;
...
#[test]
fn primary_device_attributes_response_works() {
...
mod selection_logic_tests {
    ...
    #[test]
    fn extend_selection_active_and_inactive_works() {
        let mut emu = create_test_emulator(10, 5);
    ...
    #[test]
    fn apply_selection_clear_click_and_drag_works() {
        let mut emu = create_test_emulator(10, 5);
...
mod get_selected_text_tests {
    ...
    #[test]
    fn get_selected_text_no_selection_works() {
        let emu = create_test_emulator(10, 5);
        assert_eq!(emu.get_selected_text(), None);
    }

    #[test]
    fn get_selected_text_single_line_works() {
        let mut emu = create_test_emulator(10, 5);
    ...
    #[test]
    fn get_selected_text_single_line_trailing_spaces_in_selection_works() {
    ...
    #[test]
    fn get_selected_text_multi_line_works() {
        let mut emu = create_test_emulator(10, 5);
        fill_emulator_screen(
            &mut emu,
            vec![
    ...
    #[test]
    fn get_selected_text_multi_line_full_lines_works() {
        let mut emu = create_test_emulator(10, 3);
        fill_emulator_screen(
            &mut emu,
            vec![
    ...
    #[test]
    fn get_selected_text_line_boundaries_works() {
        let mut emu = create_test_emulator(10, 2);
        fill_emulator_screen(
            &mut emu,
    ...
    #[test]
    fn get_selected_text_empty_cells_within_grid_works() {
    ...
    #[test]
    fn get_selected_text_selection_beyond_line_length_works() {
        let mut emu = create_test_emulator(10, 1);
    ...
    #[test]
    fn get_selected_text_reversed_points_works() {
        let mut emu = create_test_emulator(10, 5);
        fill_emulator_screen(&mut emu, vec!["Hello World".to_string()]);
...
mod paste_text_tests {
    ...
    #[test]
    fn paste_text_bracketed_off_simple_works() {
    ...
    #[test]
    fn paste_text_bracketed_off_with_newline_works() {
    ...
    #[test]
    fn paste_text_bracketed_off_causes_wrap_works() {
    ...
    #[test]
    fn paste_text_bracketed_on_logs_warning_processes_chars_works() {
        let mut emu = create_test_emulator(20, 1);
    ...
    #[test]
    fn ansi_resize_sets_terminal_dimensions_works() {
    ...
    #[test]
    fn ansi_resize_updates_snapshot_dimensions_works() {
        let mut emu = create_test_emulator(80, 24);
    ...
    #[test]
    fn ansi_resize_with_zero_rows_ignored_works() {
        let mut emu = create_test_emulator(80, 24);
    ...
    #[test]
    fn ansi_resize_with_zero_cols_ignored_works() {
        let mut emu = create_test_emulator(80, 24);
    ...
    #[test]
    fn ansi_resize_with_missing_params_ignored_works() {
        let mut emu = create_test_emulator(80, 24);
    ...
    #[test]
    fn window_manipulation_report_size_works() {
        let mut emu = create_test_emulator(80, 24);
