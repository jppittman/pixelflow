...
mod tests {
    ...
    #[test]
    fn verify_map_key_not_found_symbol_mismatch() {
    ...
    #[test]
    fn verify_map_key_not_found_modifier_mismatch() {
        let bindings = vec![Keybinding {
            key: KeySymbol::Char('C'),
            mods: Modifiers::CONTROL | Modifiers::SHIFT,
            action: UserInputAction::InitiateCopy,
    ...
    #[test]
    fn verify_map_key_not_found_empty_bindings() {
    ...
    #[test]
    fn verify_map_key_multiple_bindings_first_match() {
        let bindings = vec![
            Keybinding {
