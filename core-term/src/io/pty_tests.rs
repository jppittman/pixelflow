...
#[test]
fn pty_spawn_successful_should_work() {
...
#[test]
fn pty_read_write_interaction_should_work() {
...
#[test]
fn pty_resize_successful_should_work() {
...
#[test]
fn pty_child_termination_on_drop_should_work() {
    let config = PtyConfig {
        command_executable: "sleep",
...
#[test]
fn pty_spawn_invalid_command_should_work() {
