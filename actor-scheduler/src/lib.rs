...
mod troupe_tests {
    ...
    #[test]
    fn verify_troupe_directory_pattern() {
...
mod troupe_nesting_tests {
    ...
    #[test]
    fn verify_troupe_two_phase_pattern() {
        // Phase 1: Create child troupe (no threads yet)
    ...
    #[test]
    fn verify_exposed_handles_outlive_troupe_struct() {
        let exposed = {
            let mut child = WorkerTroupe::new();
...
mod shutdown_tests {
    ...
    #[test]
    fn verify_shutdown_immediate_exits_quickly_under_flood() {
        let (tx, mut rx) =
    ...
    #[test]
    fn verify_shutdown_drain_control_processes_control_and_mgmt() {
        let (tx, mut rx) =
    ...
    #[test]
    fn verify_shutdown_drain_all_processes_everything() {
        let (tx, mut rx) = ActorScheduler::new_with_shutdown_mode(
            100,
            100,
            ShutdownMode::DrainAll {
    ...
    #[test]
    fn verify_shutdown_drain_all_timeout_fallback() {
        let (tx, mut rx) = ActorScheduler::new_with_shutdown_mode(
