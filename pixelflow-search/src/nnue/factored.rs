...
mod tests {
    ...
    #[test]
    fn consolidated_param_count_works() {
    ...
    #[test]
    fn rule_features_initialization_works() {
    ...
    #[test]
    fn encode_rule_deterministic_works() {
    ...
    #[test]
    fn bilinear_score_computation_works() {
        let net = ExprNnue::new_random(42);
    ...
    #[test]
    fn graph_acc_normalize_unit_norm_per_section_works() {
        let emb = OpEmbeddings::new_random(42);
    ...
    #[test]
    fn graph_acc_normalize_scalars_preserved_works() {
        let emb = OpEmbeddings::new_random(42);
        let mut gacc = GraphAccumulator::new();
        gacc.add_edge(&emb, OpKind::Add, OpKind::Mul);
        gacc.add_leaf();
    ...
    #[test]
    fn graph_acc_normalize_zero_is_safe_works() {
    ...
    #[test]
    fn graph_acc_normalize_in_place_matches_normalized_works() {
        let emb = OpEmbeddings::new_random(42);
        let mut gacc = GraphAccumulator::new();
        gacc.add_edge(&emb, OpKind::Add, OpKind::Mul);
        gacc.add_edge(&emb, OpKind::Mul, OpKind::Var);
    ...
    #[test]
    fn graph_acc_normalize_scale_invariance_works() {
    ...
    #[test]
    fn graph_acc_normalize_idempotent_works() {
    ...
    #[test]
    fn graph_acc_remove_leaf_saturates_at_zero_works() {
