...
mod tests {
    ...
    #[test]
    fn algebraic_rules_preserve_semantics_works() {
    ...
    #[test]
    fn trig_rules_preserve_semantics_works() {
        let pts = standard_test_points();
        let mut a = ExprArena::new();
    ...
    #[test]
    fn associativity_left_to_right_works() {
    ...
    #[test]
    fn associativity_right_to_left_works() {
        // v0 + (v1 + v2) should produce (v0 + v1) + v2 in the e-graph
        let mut a = ExprArena::new();
    ...
    #[test]
    fn associativity_min_max_works() {
        let pts = standard_test_points();
        let mut a = ExprArena::new();
    ...
    #[test]
    fn associativity_templates_works() {
