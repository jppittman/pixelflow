...
pub use graph::{
    ApplyResult, Congruence, EGraph, EGraphBatch, HARD_CLASS_LIMIT, RewriteTarget, SaturationStats,
...
pub use ops::Op;
pub use optimizer::{
    Budget, Limits, Observer, Optimized, Optimizer, OptimizerStats, PRODUCTION_CONGRUENCE,
};
pub use provenance::{
