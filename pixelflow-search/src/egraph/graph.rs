...
mod tests {
    ...
    #[test]
    fn mul_sub_pattern_with_vars_works() {
        // x*x - (y - z)
        let mut eg = egraph_with_rules();
        let x = eg.add(ENode::Var(0));
    ...
    #[test]
    fn mul_sub_pattern_with_fma_works() {
    ...
    #[test]
    fn discriminant_structure_works() {
    ...
    #[test]
    fn depth_penalty_calculation_works() {
    ...
    #[test]
    fn depth_aware_extraction_works() {
