...
mod tests {
    ...
    #[test]
    fn verify_eigen_first_eigenvalue_is_one() {
    ...
    #[test]
    fn verify_bspline_patch_flat_plane() {
    ...
    #[test]
    fn verify_bspline_patch_corners() {
        // Flat grid
        let mut control_points = [[0.0f32; 3]; 16];
        for i in 0..4 {
            for j in 0..4 {
    ...
    #[test]
    fn verify_validate_eigen_domain_accepts_valid() {
    ...
    #[test]
    fn verify_eigen_patch_subpatch_routing() {
    ...
    #[test]
    fn verify_recursive_tiling_constant_surface() {
        // Constant control points - surface should be constant everywhere
