...
mod tests {
    ...
    #[test]
    fn rasterizer_actor_basic_should_initialize_when_created() {
        // Step 1: Spawn with setup handle
    ...
    #[test]
    fn rasterizer_actor_thread_count_should_update_when_set() {
        // Spawn with setup
    ...
    #[test]
    fn rasterizer_actor_should_pause_and_resume_when_commanded() {
        // Spawn with setup
        let (setup_handle, actor_thread) = RasterizerActor::<Rgba8>::spawn_with_setup(1);
