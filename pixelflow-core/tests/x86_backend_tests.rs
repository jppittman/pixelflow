...
mod tests {
    ...
    #[test]
    fn sse2_arithmetic_computes_correct_simd_values() {
    ...
    #[test]
    fn sse2_sequential_initializes_with_ascending_values() {
    ...
    #[test]
    fn sse2_logic_performs_correct_simd_comparisons() {
    ...
    #[test]
    fn sse2_bitwise_operations_apply_correct_masks() {
    ...
    #[test]
    fn sse2_math_computes_accurate_transcendental_functions() {
    ...
    #[test]
    fn sse2_mask_any_all_evaluates_correct_boolean_reductions() {
    ...
    #[test]
    #[should_panic]
    fn sse2_store_panics_when_slice_is_too_small() {
        let a = F32x4::default();
    ...
    #[test]
    fn sse2_reciprocal_math_computes_correct_approximations() {
        let a = F32x4::splat(4.0);
        let mut out = [0.0; 4];
