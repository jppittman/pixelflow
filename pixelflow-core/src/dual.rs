...
mod tests {
    ...
    #[test]
    fn dual2_arithmetic_should_succeed_when_invoked() {
    ...
    #[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
    #[test]
    fn dual2_sqrt_should_succeed_when_invoked() {
        let x = Dual2::<f32>::x(3.0);
        let y = Dual2::<f32>::y(4.0);
    ...
    #[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
    #[test]
    fn dual3_normal_should_succeed_when_invoked() {
    ...
    #[test]
    fn dual_select_should_succeed_when_invoked() {
    ...
    #[test]
    fn dual_comparison_should_succeed_when_invoked() {
        let x = Dual2::<f32>::x(3.0);
        let y = Dual2::<f32>::y(4.0);
    ...
    #[test]
    fn dual_chain_rule_mul_should_succeed_when_invoked() {
        // Test: f(x) = x², f'(x) = 2x
        // At x = 3: x² = 9, 2x = 6
    ...
    #[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
    #[test]
    fn dual_chain_rule_sin_should_succeed_when_invoked() {
