...
mod tests {
    ...
    #[test]
    fn dual2_arithmetic_produces_correct_values() {
    ...
    #[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
    #[test]
    fn dual2_sqrt_computes_correct_derivative() {
        let x = Dual2::<f32>::x(3.0);
        let y = Dual2::<f32>::y(4.0);
    ...
    #[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
    #[test]
    fn dual3_normal_returns_unit_length_vector() {
    ...
    #[test]
    fn dual_select_returns_correct_branch_based_on_condition() {
    ...
    #[test]
    fn dual_comparison_evaluates_only_value_components() {
        let x = Dual2::<f32>::x(3.0);
        let y = Dual2::<f32>::y(4.0);
    ...
    #[test]
    fn dual_multiplication_applies_product_rule() {
        // Test: f(x) = x², f'(x) = 2x
        // At x = 3: x² = 9, 2x = 6
    ...
    #[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
    #[test]
    fn dual_sin_applies_chain_rule() {
