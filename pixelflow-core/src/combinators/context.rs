...
mod context_domain_tests {
    ...
    #[test]
    fn verify_mul_dz_x_in_context_domain() {
    ...
    #[test]
    fn verify_muladd_dz_in_context_domain() {
    ...
    #[test]
    fn verify_comparison_in_context_domain() {
    ...
    #[test]
    fn verify_and_in_context_domain() {
        // (a > b) & (a < c) should work
        let a = CtxVar::<A0, 0>::new();
        let b = CtxVar::<A0, 1>::new();
    ...
    #[test]
    fn verify_geometry_mask_pattern() {
    ...
    #[test]
    fn verify_select_in_context_domain() {
    ...
    #[test]
    fn verify_select_with_valof_in_context_domain() {
    ...
    #[test]
    fn verify_checker_like_pattern() {
    ...
    #[test]
    fn verify_muladd_select_pattern() {
