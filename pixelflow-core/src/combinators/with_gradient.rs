...
mod tests {
    ...
    #[test]
    fn with_gradient_2d_distance_should_succeed_when_invoked() {
    ...
    #[test]
    fn with_gradient_2d_quadratic_should_succeed_when_invoked() {
        // Quadratic: x² + y²
        // At (2, 3): value = 4 + 9 = 13
        // Gradient: (2x, 2y) = (4, 6)
    ...
    #[test]
    fn with_gradient_2d_product_should_succeed_when_invoked() {
        // Product: x * y
        // At (3, 5): value = 15
        // Gradient: (y, x) = (5, 3)
        let product = X * Y;
    ...
    #[test]
    fn with_gradient_3d_distance_should_succeed_when_invoked() {
    ...
    #[test]
    fn with_gradient_3d_product_should_succeed_when_invoked() {
        // 3D product: x * y * z
        // At (2, 3, 4): value = 24
