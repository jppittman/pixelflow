...
mod tests {
    ...
    #[test]
    fn verify_2d_spatial_should_succeed_when_invoked() {
    ...
    #[test]
    fn verify_4d_spatial_should_succeed_when_invoked() {
        let domain = (
            Field::from(1.0),
            Field::from(2.0),
            Field::from(3.0),
    ...
    #[test]
    fn let_extended_should_succeed_when_invoked() {
    ...
    #[test]
    fn nested_let_should_succeed_when_invoked() {
