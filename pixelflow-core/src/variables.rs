...
mod tests {
    ...
    #[test]
    fn x_on_2d_should_succeed_when_invoked() {
    ...
    #[test]
    fn y_on_2d_should_succeed_when_invoked() {
        let domain = (Field::from(3.0), Field::from(4.0));
    ...
    #[test]
    fn z_on_2d_is_zero_should_succeed_when_invoked() {
        let domain = (Field::from(3.0), Field::from(4.0));
    ...
    #[test]
    fn on_4d_should_succeed_when_invoked() {
        let domain = (
            Field::from(1.0),
            Field::from(2.0),
            Field::from(3.0),
