...
mod tests {
    ...
    #[test]
    fn verify_coordinate_variables_are_zst() {
    ...
    #[test]
    fn verify_spherical_harmonics_are_zst() {
    ...
    #[test]
    fn verify_operators_with_zst_operands_are_zst() {
    ...
    #[test]
    fn verify_complex_expression_is_zst() {
        use crate::variables::{X, Y};
    ...
    #[test]
    fn verify_combinators_with_zst_operands_are_zst() {
