...
> it will start building deleted types. `factored.rs`, the NNUE forward pass and every module it proposes to split
> that file into were deleted with the extraction-head program in Sep 2026.
