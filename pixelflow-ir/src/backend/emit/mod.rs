...
mod tests {
    ...
    #[test]
    fn verify_frame_layout_one_spill() {
    ...
    #[test]
    fn verify_frame_layout_alignment() {
        let spilled = [
            regalloc::ValueId(1),
            regalloc::ValueId(2),
            regalloc::ValueId(3),
    ...
    #[test]
    fn verify_resolve_binary_no_spills() {
    ...
    #[test]
    fn verify_resolve_binary_left_spilled() {
    ...
    #[test]
    fn verify_resolve_binary_both_spilled() {
    ...
    #[test]
    fn verify_resolve_dst_spilled_generates_store() {
    ...
    #[test]
    fn verify_resolve_muladd_fmla_path() {
    ...
    #[test]
    fn verify_resolve_muladd_decomposed_both_ab_spilled() {
    ...
    #[test]
    fn verify_resolve_muladd_decomposed_all_three_spilled() {
    ...
    #[test]
    fn verify_arena_to_schedule_simple() {
        use crate::arena::ExprArena;
    ...
    #[test]
    fn verify_arena_to_schedule_filters_unreachable() {
        use crate::arena::ExprArena;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_arena_compile_simple() {
        use crate::arena::ExprArena;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_arena_compile_with_constant() {
        use crate::arena::ExprArena;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_arena_compile_with_spills() {
        use crate::arena::ExprArena;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_scanline_handcoded_add() {
        use core::arch::aarch64::*;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_scanline_reg_offset_encoding() {
        use core::arch::aarch64::*;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_scanline_with_constants() {
        use crate::arena::ExprArena;
        use core::arch::aarch64::*;
    ...
    #[test]
    #[cfg(target_arch = "aarch64")]
    fn verify_scanline_matches_per_batch() {
        use crate::arena::ExprArena;
        use core::arch::aarch64::*;
    ...
    fn verify_scanline_matches_per_batch_x86() {
    ...
    #[test]
    #[cfg(all(target_arch = "x86_64", not(target_feature = "avx512f")))]
    fn verify_x86_unary_builtins_match_scalar() {
    ...
    #[test]
    #[cfg(all(target_arch = "x86_64", not(target_feature = "avx512f")))]
    fn verify_x86_binary_ternary_builtins_match_scalar() {
        use core::arch::x86_64::*;
