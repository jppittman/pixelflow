...
mod tests {
    ...
    #[test]
    fn verify_hoisted_schedule_partitioning() {
        use crate::arena::ExprArena;
    ...
    #[test]
    fn verify_hoisted_schedule_no_setup_for_x_only() {
        use crate::arena::ExprArena;
        use crate::backend::emit;
        use crate::kind::OpKind;
    ...
    #[test]
    fn verify_hoisted_schedule_constants_not_hoisted() {
        use crate::arena::ExprArena;
        use crate::backend::emit;
        use crate::kind::OpKind;
