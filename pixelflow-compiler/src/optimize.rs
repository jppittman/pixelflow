...
mod tests {
    ...
    #[test]
    fn dag_optimization_shared_subexpr_works() {
    ...
    #[test]
    fn dag_optimization_triple_shared_works() {
    ...
    #[test]
    fn dag_optimization_no_sharing_works() {
    ...
    #[test]
    fn full_pipeline_discriminant_works() {
        use crate::codegen;
