...
use crate::platform::macos::cocoa::{ActivationOptions, EventDequeue, self, event_type, NSApplication, NSPasteboard};
...
impl MetalOps {
    pub fn new(event_tx: EngineActorHandle) -> Result<Self, RuntimeError> {
        ...
        let app = unsafe {
            ...
            app.activate_ignoring_other_apps(ActivationOptions::IgnoreOtherApps);
